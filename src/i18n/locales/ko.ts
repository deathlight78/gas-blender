export const ko = {
  ...
  info_deco_content:
    ...
    '격실 계수는 표준 ZHL-16C 값을 사용하며, MultiDeco 2.26 바이너리 분석으로 정확성이 검증되었습니다.\n\n' +
    '정지 탈출 기준: GF-ceiling이 현재 정지 수심 이하로 내려오면 즉시 다음 정지로 이동합니다. 기체 전환 시 헬륨 탈기 가속이 즉시 반영되어 불필요한 추가 대기가 발생하지 않습니다 (MultiDeco·Shearwater 방식).\n\n' +
    '──────────────────────\n\n' +
    '◆ Gradient Factor (GF)\n\n' +
    '감압의 보수성을 조절하는 두 값입니다. 낮을수록 보수적(감압 정지 길어짐), 높을수록 공격적(짧아짐).\n' +
    '• GF Low: 첫 감압 정지 수심 기준. 상승 중 off-gassing을 반영한 동적 탐색으로 결정되며, 낮을수록 더 깊은 곳에서 먼저 정지합니다.\n' +
    ...
    '──────────────────────\n\n' +
    '◆ 감압 기체 (실린더 번호 표시)\n\n' +
    '감압 기체를 추가하면 "실린더 1, 2, 3..."처럼 번호가 붙습니다. 각 카드 하단에 ppO₂와 N₂%가 자동 표시되어 기체 전환 안전 여부를 바로 확인할 수 있습니다.\n\n' +
    '전환 수심은 설정 탭의 감압 ppO₂ 한도를 기준으로 자동 계산됩니다.\n' +
    'MOD = (ppO₂ 한도 ÷ fO₂ − 1) × 10, 3m 단위 내림\n' +
    '예: EAN50, 한도 1.4 bar → MOD = (1.4 ÷ 0.5 − 1) × 10 = 18m\n\n' +
    'O₂ 농도가 높은 기체일수록 질소 방출 속도가 빨라져 감압 시간이 단축됩니다.\n\n' +
    '──────────────────────\n\n' +
    '◆ ICD (역확산) 경고\n\n' +
