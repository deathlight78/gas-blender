export const ko = {
  ...
  info_blending_content:
    ...
    '⑤ O₂ 소비량 추정: CCR은 대사로 소비된 O₂를 자동 보충합니다. 표준 소비율 0.5 L/min 기준으로 다이빙 시간 동안의 총 O₂ 소비량과 탱크 압력 강하를 추정합니다.',
  ...
  info_deco_content:
    '◆ 이 탭에서 할 수 있는 것\n\n' +
    '수심·바닥 시간·기체·GF를 입력하면 Bühlmann ZHL-16C 알고리즘으로 감압 정지 테이블과 산소 독성 누적(CNS%·OTU)을 계산합니다. 복수 감압 기체 전환도 지원합니다.\n\n' +
    '──────────────────────\n\n' +
    ...
    '──────────────────────\n\n' +
    '◆ 감압 기체 전환 (Multi-Gas)\n\n' +
    '특정 수심 이하에서 O₂ 농도가 높은 기체로 전환하면 질소 방출 속도가 빨라져 감압 시간이 단축됩니다. 전환 수심은 그 기체의 ppO₂가 deco 한도(기본 1.6 bar)를 넘지 않는 가장 깊은 수심으로 설정합니다.\n\n' +
    '──────────────────────\n\n' +
    '◆ ICD (역확산) 경고\n\n' +
    '기체 전환 시 질소 분압이 갑자기 높아지는 상황입니다. 트라이믹스에서 고농도 O₂ 감압 기체로 바꿀 때 발생하기 쉽습니다. fN₂ 차이가 0.5% 이상이면 경고를 표시합니다.\n\n' +
    '──────────────────────\n\n' +
    '◆ Bailout 모드\n\n' +
    'CCR 다이버가 비상 시 OC(개방회로)로 전환했을 때의 감압 계획입니다. 더 보수적인 Bailout GF를 적용해 안전 마진을 확보합니다. Bailout GF는 설정 탭에서 별도 지정할 수 있습니다.\n\n' +
    '──────────────────────\n\n' +
    '◆ CNS% · OTU (산소 독성)\n\n' +
