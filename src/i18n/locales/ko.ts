export const ko = {
  ...
  calc_endurance_subtitle: '현재 탱크로 계획 수심에서 사용 가능한 시간',
  calc_endurance_current_pressure: '현재 탱크 압력',
  ...
  settings_air_precise: '정밀 (O₂ 20.9% / N₂ 78.1%)',
  settings_air_approx: '계산용 (O₂ 21% / N₂ 79%)',
